...
static QStringList locales = {"bg", "cs", "de", "en", "es", "fr", "hr", "it", "sw", "lt", "hu", "nl", "no_nb", "pl", "pt", "ru", "sl", "fi", "sv", "uk", "zh"};
static QStringList langs = {"Български", "Čeština", "Deutsch", "English", "Español", "Français", "Hrvatski", "Italiano", "Kiswahili", "Lietuvių", "Magyar", "Nederlands", "Norsk Bokmål", "Polski", "Português", "Русский", "Slovenščina", "Suomi", "Svenska", "Українська", "简体中文"};
